...
#  strings are immutable, strings me changes nahi kr sakte. but list me aisa kr sakte h
#  for eg
list1 =["apple", "orange", 1.23, False, 1234, "mango","tree"]
# print(list1)
list1[1]="grapes"
# print(list1)
# we can even do slicing in list just like strings
# print(list1[3:5])
